Shader "AppleGrapple/UICircleMask"
{
    // Same idea as AppleGrapple/SpriteCircleMask but for uGUI: clips a rectangular Image into a circle
    // via UV distance in the fragment shader, with no stencil pass — avoids the extra batches a UI
    // Mask component introduces (each Mask forces its own stencil write and breaks batching).
    Properties
    {
